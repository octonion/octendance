...
competition = u"Euro 2016".encode('utf-8')
...
names = {}
names[300360759] = ["France", "Iceland"]

team_name = {}
team_name["fra"] = "France"
team_name["isl"] = "Iceland"

team_ids = {}
team_ids[300360759] = ["fra", "isl"]
...
for id in ids:
    ...
    string = "%s\n%s - %s\n\n" % (competition, home_name, away_name)
    ...
    string += "%s wins - %.1f%%\n" % (home_name, home_win*100)
    string += "%s wins - %.1f%%" % (away_name, away_win*100)
    string += hashtag
    print string
    ...
    for game in live["matches"]:
        ...
        if (new_status == "fifa.half-time"):
            ...
            if (home_score==away_score):
                #string = string + "Entering penalty kicks\n"
                string = string + "Entering extra time\n"
                string += hashtag
                print string
                print
