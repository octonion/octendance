...
names = {}
names[match_id] = ["#ValenciaCF", "#RCDEspanyol"]

team_ids = {}
team_ids[match_id] = [94, 88]

team_name = {}
team_name[94] = "Valencia CF"
team_name[88] = "RCD Espanyol"
...
while True:
    ...
    for game in live["matches"]:
        ...
        if (new_status == "fifa.half-time"):
            ...
            if (home_p[id] == None) or (abs(home_reg-home_p[id])>=0.05):
